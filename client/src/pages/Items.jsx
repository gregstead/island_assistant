          ...
          <Container maxWidth="sm">
            ...
            <div className={classes.heroSearch}>
              <Grid container spacing={2} justify="center">
                <Grid item>
                  <FormControl variant="outlined" className={classes.formControl} style={{ backgroundColor: "mintcream", width: "25vw" }}>
                ...
                <Grid item>
                  <TextField label="Item name" name="searchTerm" onChange={handleChange} type="search" value={searchState.searchTerm} variant="outlined" style={{  backgroundColor: "mintcream", width: "25vw" }}></TextField>
