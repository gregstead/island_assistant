    ...
    <div className={classes.root}>
      ...
      >
        <Toolbar
          ...
          style={{
            backgroundImage:
              "linear-gradient(30DEG, #017c74, #7cc9c3, #ef785a, #febdc3, #f5c24c, #fcea64)",
            height: "68px",
          }}
        >
          <IconButton
        ...
        <List>
          {[
            ...
            >
              <ListItem
                button
                style={{ paddingLeft: "18px", paddingRight: "23px" }}
              >
                <ListItemIcon>
                  <Avatar
                    style={{
                  ...
                  >
                    ...
                    {index === 2 && (
                      <HomeIcon key={"home"} style={{ color: "#7cc9c3" }} />
                    )}
                    {index === 3 && (
                      <CategoryIcon
                        key={"items"}
